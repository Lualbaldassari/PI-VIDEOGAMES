    ...
    <div>
      <form onSubmit={(e) => handleSubmit(e)} className={s.box_form}>
        <div className={s.form}>
          ...
          <div className={s.grupo}>
            <select
              className={s.select_create}
              id="genres"
              defaultValue=""
              onChange={(e) => handleGenres(e)}
            >
              <option className={s.option_create} value="" disabled hidden>
                Elija los géneros...
              </option>
              {generos.map((g) => {
                return (
                  <option className={s.option_create} key={g.id} value={g.name}>
                    {g.name}
                  </option>
                );
              })}
          ...
          <div className={s.grupo}>
            ...
            >
              ...
              {plataformas?.map((p) => {
                return (
                  <option className={s.option_create} value={p} key={p}>
                    {p}
                  </option>
                );
              })}
        ...
        <div className={s.box_home}>
          <NavLink to={"/home"} className={s.back_home}>
            Cancelar
          </NavLink>
        </div>
      </form>
